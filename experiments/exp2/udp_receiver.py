...
def main() -> None:
    ...
    result = {
        ...
        "sequence_loss_packets": lost,
        "sequence_loss_fraction": (lost / expected) if expected else None,
        "duplicates": duplicates,
        "out_of_order": out_of_order,
        "receive_span_seconds": duration_s,
        "received_payload_mbps": (payload_bytes * 8 / duration_s / 1e6) if duration_s else 0.0,
    }
