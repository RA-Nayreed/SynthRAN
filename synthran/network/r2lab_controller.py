...
from synthran.network.r2lab_lifecycle import (
    CleanupEvidence,
    CleanupState,
    ReleaseAssessment,
    release_assessment,
)
from synthran.network.r2lab_operations import (
    VerifiedPduOperation,
    execute_verified_pdu_transition,
)
from synthran.network.r2lab_power import PowerState, R2LabPowerStateError
from synthran.network.r2lab_qfit import R2LabQfitStateError
from synthran.network.r2lab_qfit_operations import (
...
def execute_release(
    *,
    ...
    report(
        f"ue-power-off-release: {'OK' if ue_evidence.clean else 'UNRESOLVED'}"
    )
